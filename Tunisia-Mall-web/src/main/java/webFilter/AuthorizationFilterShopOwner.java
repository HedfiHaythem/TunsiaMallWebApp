...
@WebFilter("/WebBackOffice/ShopOwner/*")
public class AuthorizationFilterShopOwner implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {    
        ...
        boolean loggedIn = (session != null) && ((session.getAttribute("shopOwner") != null));
